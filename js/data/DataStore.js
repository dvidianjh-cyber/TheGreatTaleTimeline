            ...
            if (ent.lifespan) {
                if (ent.lifespan.birth_lane_id && ent.lifespan.start_tu !== undefined) {
                    syntheticEvents.push({
                        ...
                        sub_area: ent.lifespan.birth_sub_area || ent.lifespan.sub_area || (ent.metadata && ent.metadata.sub_area),
                ...
                if (ent.lifespan.death_lane_id && ent.lifespan.death_tu !== undefined) {
                    syntheticEvents.push({
                        ...
                        sub_area: ent.lifespan.death_sub_area || ent.lifespan.sub_area || (ent.metadata && ent.metadata.sub_area),
                ...
                if (ent.lifespan.departure_lane_id && ent.lifespan.departure_tu !== undefined) {
                    syntheticEvents.push({
                        ...
                        sub_area: ent.lifespan.departure_sub_area || ent.lifespan.sub_area || (ent.metadata && ent.metadata.sub_area),
